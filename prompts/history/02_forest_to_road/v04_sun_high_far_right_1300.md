...
TIMING
0.0–5.0s — already walking with exactly the same gait and forward axis as generation 01. The canopy is still partly closed, but the road is now intermittently visible through the trunks ahead.
5.0–8.0s — while the walk continues unchanged, the gaze makes one restrained natural lift toward the opening canopy and pale-blue sky straight ahead. It does not pan toward the far-right sun, which stays outside the normal forward frame. No exaggerated tilt and no interruption of footfall rhythm.
...
Late spring turning into early summer, exactly 1:00 PM. The walking direction is the same fixed forward axis as generation 01. The single high sun stays far to the right of that axis, approximately 60–75 degrees right of the camera's forward heading. It is high above the upper-right edge of the normal forward view, not near the centre and not directly ahead. While the camera looks forward or makes the scripted straight-ahead upward gaze, the solar disc remains outside the frame; only its directional light is visible. Direct highlights enter consistently from the high right side and cast shadows leftward and slightly backward. The sun keeps this same world position for the entire take and across both forest generations.

Bright mostly sunny pale-blue sky with a few small separated soft-white clouds and large blue gaps, never overcast. Neutral daylight white balance around 5600K. New-growth foliage is true natural green; pine bark, birch bark, moss, leaf litter and asphalt remain materially accurate. The exposure rises naturally as the same canopy thins, but the sun direction, weather, white balance and grade never change. Medium contrast, open midtones, readable shadows, retained highlights, slight atmospheric haze and even exposure corner to corner. No visible solar disc during the forward or upward gaze. No direct glare into the lens. No rear key light and no opposite-side key light. No vignette, edge darkening, teal-orange grade, sepia, HDR halo, bloom or artificial fog.

CONTINUITY WITH GENERATION 01
Same forest, same day, same forward axis and same unseen walker. Preserve identical tree species, bark character, foliage maturity, ground moisture, wind direction, optics, camera height, exact gait, colour and exact sun azimuth. In both videos the sun remains very high and far to the right of the walking axis, normally outside the forward frame; shadows remain leftward and slightly backward. Generation 02 is not a differently lit forest; it is the natural continuation of generation 01 after moving farther toward the road.
